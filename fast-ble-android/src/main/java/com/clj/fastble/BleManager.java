...
public class BleManager {
     ...
     * @return
     */
    public BluetoothGatt connect(IBleDevice bleDevice, BleGattCallback bleGattCallback) {
    ...
    public BluetoothGatt connect(String mac, BleGattCallback bleGattCallback) {
        ...
        IBleDevice bleDevice = new BleDevice(bluetoothDevice, 0, null, 0);
     ...
     * @param callback
     */
    public void notify(IBleDevice bleDevice,
                       String uuid_service,
                       String uuid_notify,
     ...
     * @param callback
     */
    public void indicate(IBleDevice bleDevice,
                         String uuid_service,
     ...
     * @return
     */
    public boolean stopNotify(IBleDevice bleDevice,
                              String uuid_service,
                              String uuid_notify) {
     ...
     * @return
     */
    public boolean stopIndicate(IBleDevice bleDevice,
                                String uuid_service,
                                String uuid_indicate) {
     ...
     * @param callback
     */
    public void write(IBleDevice bleDevice,
                      String uuid_service,
                      String uuid_write,
                      byte[] data,
     ...
     * @param callback
     */
    public void read(IBleDevice bleDevice,
                     String uuid_service,
                     String uuid_read,
     ...
     * @param callback
     */
    public void readRssi(IBleDevice bleDevice,
     ...
     * @param callback
     */
    public void setMtu(IBleDevice bleDevice,
                       int mtu,
     ...
     *                                  specified range.
     */
    public boolean requestConnectionPriority(IBleDevice bleDevice, int connectionPriority) {
    ...
    public IBleDevice convertBleDevice(BluetoothDevice bluetoothDevice) {
        return new BleDevice(bluetoothDevice);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public IBleDevice convertBleDevice(ScanResult scanResult) {
        if (scanResult == null) {
    ...
    public BleBluetooth getBleBluetooth(IBleDevice bleDevice) {
    ...
    public BluetoothGatt getBluetoothGatt(IBleDevice bleDevice) {
    ...
    public List<BluetoothGattService> getBluetoothGattServices(IBleDevice bleDevice) {
    ...
    public void removeConnectGattCallback(IBleDevice bleDevice) {
        BleBluetooth bleBluetooth = getBleBluetooth(bleDevice);
        if (bleBluetooth != null)
            bleBluetooth.removeConnectGattCallback();
    }

    public void removeRssiCallback(IBleDevice bleDevice) {
        BleBluetooth bleBluetooth = getBleBluetooth(bleDevice);
        if (bleBluetooth != null)
            bleBluetooth.removeRssiCallback();
    }

    public void removeMtuChangedCallback(IBleDevice bleDevice) {
        BleBluetooth bleBluetooth = getBleBluetooth(bleDevice);
        if (bleBluetooth != null)
            bleBluetooth.removeMtuChangedCallback();
    }

    public void removeNotifyCallback(IBleDevice bleDevice, String uuid_notify) {
        BleBluetooth bleBluetooth = getBleBluetooth(bleDevice);
        if (bleBluetooth != null)
            bleBluetooth.removeNotifyCallback(uuid_notify);
    }

    public void removeIndicateCallback(IBleDevice bleDevice, String uuid_indicate) {
        BleBluetooth bleBluetooth = getBleBluetooth(bleDevice);
        if (bleBluetooth != null)
            bleBluetooth.removeIndicateCallback(uuid_indicate);
    }

    public void removeWriteCallback(IBleDevice bleDevice, String uuid_write) {
        BleBluetooth bleBluetooth = getBleBluetooth(bleDevice);
        if (bleBluetooth != null)
            bleBluetooth.removeWriteCallback(uuid_write);
    }

    public void removeReadCallback(IBleDevice bleDevice, String uuid_read) {
        BleBluetooth bleBluetooth = getBleBluetooth(bleDevice);
        if (bleBluetooth != null)
            bleBluetooth.removeReadCallback(uuid_read);
    }

    public void clearCharacterCallback(IBleDevice bleDevice) {
        BleBluetooth bleBluetooth = getBleBluetooth(bleDevice);
        if (bleBluetooth != null)
    ...
    public List<IBleDevice> getAllConnectedDevice() {
        if (multipleBluetoothController == null)
            return null;
     ...
     */
    public int getConnectState(IBleDevice<BluetoothDevice> bleDevice) {
        if (bleDevice != null) {
    ...
    public boolean isConnected(IBleDevice bleDevice) {
        return getConnectState(bleDevice) == BluetoothProfile.STATE_CONNECTED;
    }

    public boolean isConnected(String mac) {
        List<IBleDevice> list = getAllConnectedDevice();
        for (IBleDevice bleDevice : list) {
            if (bleDevice != null) {
    ...
    public void disconnect(IBleDevice bleDevice) {
        if (multipleBluetoothController != null) {
