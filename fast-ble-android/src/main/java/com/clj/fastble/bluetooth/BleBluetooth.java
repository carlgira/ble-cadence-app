...
public class BleBluetooth {
    ...
    public BleBluetooth(IBleDevice bleDevice) {
    ...
    public synchronized BluetoothGatt connect(IBleDevice bleDevice,
                                              boolean autoConnect,
                                              BleGattCallback callback) {
        return connect(bleDevice, autoConnect, callback, 0);
    }

    public synchronized BluetoothGatt connect(IBleDevice<BluetoothDevice> bleDevice,
                                              boolean autoConnect,
                                              BleGattCallback callback,
    ...
    private BluetoothGattCallback coreGattCallback = new BluetoothGattCallback() {
            ...
            while (iterator.hasNext()) {
                ...
                if (callback instanceof BleNotifyCallback) {
                    ...
                    if (characteristic.getUuid().toString().equalsIgnoreCase(bleNotifyCallback.getKey())) {
                        Handler handler = (Handler) bleNotifyCallback.getHandler();
                        if (handler != null) {
            ...
            while (iterator.hasNext()) {
                ...
                if (callback instanceof BleIndicateCallback) {
                    ...
                    if (characteristic.getUuid().toString().equalsIgnoreCase(bleIndicateCallback.getKey())) {
                        Handler handler = (Handler) bleIndicateCallback.getHandler();
                        if (handler != null) {
                            Message message = handler.obtainMessage();
            ...
            while (iterator.hasNext()) {
                ...
                if (callback instanceof BleWriteCallback) {
                    ...
                    if (characteristic.getUuid().toString().equalsIgnoreCase(bleWriteCallback.getKey())) {
                        Handler handler = (Handler) bleWriteCallback.getHandler();
                        if (handler != null) {
                            Message message = handler.obtainMessage();
            ...
            while (iterator.hasNext()) {
                ...
                if (callback instanceof BleReadCallback) {
                    ...
                    if (characteristic.getUuid().toString().equalsIgnoreCase(bleReadCallback.getKey())) {
                        Handler handler = (Handler) bleReadCallback.getHandler();
                        if (handler != null) {
                            Message message = handler.obtainMessage();
        ...
        public void onReadRemoteRssi(BluetoothGatt gatt, int rssi, int status) {
            ...
            if (bleRssiCallback != null) {
                Handler handler = (Handler) bleRssiCallback.getHandler();
                if (handler != null) {
                    Message message = handler.obtainMessage();
        ...
        public void onMtuChanged(BluetoothGatt gatt, int mtu, int status) {
            ...
            if (bleMtuChangedCallback != null) {
                Handler handler = (Handler) bleMtuChangedCallback.getHandler();
                if (handler != null) {
                    Message message = handler.obtainMessage();
